...
public class ClienteResource {
    ...
    public ResponseEntity<List<ClienteDTO>> findAll() {
        try {
            ...
            List<ClienteDTO> listDto = list.stream()
                .map(obj -> clienteService.toNewDTO(obj))  // Changed from toNewDTO to toDTO
    ...
    public ResponseEntity<ClienteDTO> findById(@PathVariable Long id) {
        ...
        ClienteDTO dto = clienteService.toNewDTO(obj);  // Changed from toNewDTO to toDTO
    ...
    public ResponseEntity<Void> insert(@Valid @RequestBody ClienteDTO dto) {
        ...
        URI uri = ServletUriComponentsBuilder.fromCurrentRequest()
            .path("/{id}")
            .buildAndExpand(obj.getId())  // Changed from getCliId to getId
            .toUri();

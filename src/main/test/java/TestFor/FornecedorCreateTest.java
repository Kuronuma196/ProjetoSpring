...
import TestPro.BaseTest;
import org.junit.Test;
import org.openqa.selenium.By;
import org.openqa.selenium.WebElement;
public class FornecedorCreateTest extends BaseTest {

    @Test
    public void testCreateFornecedorSuccessfully() {
        WebElement btnNovoFornecedor = driver.findElement(By.xpath("/html/body/app-root/app-nav/mat-sidenav-container/mat-sidenav-content/app-product-crud/button"));
        btnNovoFornecedor.click();

        driver.findElement(By.xpath("/html/body/app-root/app-nav/mat-sidenav-container/mat-sidenav-content/app-product-create/mat-card/form/mat-form-field[1]/div[1]/div[2]/div/input")).sendKeys("Fornecedor Teste");
